...
export const LocalizedStrings = {
	...
	TOOLTIP_WCAG_STATUS: 'WCAG Status',
	TOOLTIP_ACCESSIBILITY_PASS: 'PASS',
	TOOLTIP_ACCESSIBILITY_FAIL: 'FAIL',
	TOOLTIP_ACCESSIBILITY_AA_NORMAL: 'AA Normal Text',
	TOOLTIP_ACCESSIBILITY_AA_LARGE: 'AA Large Text',
	TOOLTIP_ACCESSIBILITY_AAA_NORMAL: 'AAA Normal Text',
	...
	TOOLTIP_COLOR_VALUE: 'Color value',
	...
	TOOLTIP_FORMAT_OKLAB_LABEL: 'OKLAB',
	TOOLTIP_FORMAT_OKLCH_LABEL: 'OKLCH',
	...
	COMMAND_CONVERT_COLOR_READ_ONLY_FILE: 'Cannot edit read-only file: {0}',
	COMMAND_CONVERT_COLOR_BULK_CONVERT: 'Bulk Convert',
	COMMAND_CONVERT_COLOR_BULK_CONVERT_HINT: 'Select formats using radio buttons, then convert all matches at once.',
	COMMAND_CONVERT_COLOR_REPLACE_TITLE: 'Convert to {0}',
	COMMAND_CONVERT_COLOR_COPY_TITLE: 'Copy to clipboard',
	...
	ACCESSIBILITY_VIEW_EMPTY_HINT: 'Trigger "Test accessibility" to see detailed contrast results.',
	ACCESSIBILITY_VIEW_EMPTY_CONTRAST: 'Contrast data is not available for this color.',

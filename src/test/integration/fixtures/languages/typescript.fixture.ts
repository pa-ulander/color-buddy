...
const CardComponent = `
  <div class="bg-card text-card-foreground border-border rounded-lg shadow-sm">
    ...
    <div class="bg-muted border-t border-border p-4">
      ...
      <div class="w-8 h-8 rounded definition" title="plums">Hello</div>
      <div class="w-8 h-8 rounded another-definition" title="plask">Hello</div>
      <div class="w-8 h-8 rounded one-more-definition" title="bonk">Hello</div>

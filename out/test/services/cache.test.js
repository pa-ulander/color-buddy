...
suite('Cache Service', () => {
    ...
    suite('Basic Caching', () => {
        ...
        test('set and get cache color data', () => {
            ...
            const data = [(0, helpers_1.createMockColorData)()];
        ...
        test('set updates existing cache entry', () => {
            const uri = 'file:///test.ts';
            const data1 = [(0, helpers_1.createMockColorData)({ originalText: '#ff0000' })];
            const data2 = [(0, helpers_1.createMockColorData)({ originalText: '#00ff00' })];
    ...
    suite('Delete and Clear', () => {
        ...
        test('clear removes all cached entries', () => {
            cache.set('file:///test1.ts', 1, [(0, helpers_1.createMockColorData)()]);
            cache.set('file:///test2.ts', 1, [(0, helpers_1.createMockColorData)()]);
            assert.strictEqual(cache.size, 2);
            cache.clear();
            assert.strictEqual(cache.size, 0);
